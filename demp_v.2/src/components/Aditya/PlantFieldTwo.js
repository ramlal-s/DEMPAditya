...
class PlantFieldTwo extends Component {
  render() {
    const bar1 = 45;
    return (
      <div className="col-md-4 mt-25">
        <div className="cardContainer">
          <div className="widget-title-new">
            <h2 className="stitle  fc-green ">Plant 3 (4 RAI)</h2>
          </div>
          ...
          <div>
            ...
            <ProgressBar className="pf-bar" now={70} label={`I`} />
            ...
            <div className="row">
              ...
              <div className="col-md-7 text-left">
                <p className="fs-14 fc-blue-1 mb-0 ">No equipment installed</p>
              </div>
            </div>
            <div className="row">
              <div className="col-md-4 text-right">
